 ...
 *  - q: search (phone, email, firstName, lastName)
 *  - isSubscribed: "true" | "false" | undefined (no filter)
 * --------------------------------------------------------- */
 ...
 * Use updateMany to enforce owner scope safely.
 * --------------------------------------------------------- */
 ...
 * --------------------------------------------------------- */
router.post('/contacts/unsubscribe', async (req, res) => {
  try {
